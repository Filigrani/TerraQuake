...
namespace TerraQuake
{
    internal class Terrain
    {
        ...
        public void ProcessPixel(int iX, int iY)
        {
            ...
            if (true) // Pixel can be dynamic and need to be processed.
            {
